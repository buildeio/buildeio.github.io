/*
    no moomoo Bundle Processor
    Type: prod
    Timestamp: 1673211182841
    By: Illya9999 
*/
// everythng is alreay bundled like we could just make our own bundle with webpack but this is easier tbh
!function (modules) {
    /* (webpack)/bootstrap */
...
function connectSocket(token) {
    vultrClient.start(function (address, port, gameIndex) {
            ...
            pingSocket(), setInterval(() => pingSocket(), 2500), error ? disconnect(error) : (enterGameButton.onclick = UTILS.checkTrusted(function () {
                ...
                for (var i = 0; i < icons.length; ++i) {
                    ...
                    tmpSprite.onload = function () {
                        this.isLoaded = !0;
                    }, tmpSprite.src = 'https://moomoo.io/img/icons/' + icons[i] + '.png', iconSprites[icons[i]] = tmpSprite;
                }
                ...
                for (i = 0; i < items.list.length + items.weapons.length; ++i)
                    !function (i) {
                        ...
                        if (tmpContext.translate(tmpCanvas.width / 2, tmpCanvas.height / 2), tmpContext.imageSmoothingEnabled = !1, tmpContext.webkitImageSmoothingEnabled = !1, tmpContext.mozImageSmoothingEnabled = !1, items.weapons[i]) {
                            ...
                            var tmpSprite = new Image();
                            tmpSprite.setAttribute('crossOrigin', 'anonymous');
                            ...
                            }, tmpSprite.src = 'https://moomoo.io/img/weapons/' + items.weapons[i].src + '.png', (tmpUnit = document.getElementById('actionBarItem' + i)).onmouseover = UTILS.checkTrusted(function () {
        ...
        console.error('Vultr error:', error), alert('Error:\n' + error), disconnect('Flower is updating the code..');
    });
}
        ...
        var featuredYoutuber = document.getElementById('featuredYoutube'), youtuberList = [
                {
                    name: 'Wealthy',
                    link: 'https://www.youtube.com/@wealthyDev'
                },
                {
                    name: 'Zaary',
                    link: 'https://www.youtube.com/@Zaary'
                },
                {
                    name: 'Ashureth',
                    link: 'https://www.youtube.com/@Ashureth'
                },
                {
                    name: 'O1RD',
                    link: 'https://www.youtube.com/@O1RDisPro'
                }
        ...
        function setupServerStatus() {
            ...
            tmpHTML += '<option disabled>All Servers - ' + overallTotal + ' players</option>', serverBrowser.innerHTML = tmpHTML, 'sandbox.moomoo.io' == location.hostname ? (altServerText = 'Back to MooMoo', altServerURL = '//google.com/') : (altServerText = 'Try the sandbox', altServerURL = '//google.com/'), document.getElementById('altServer').innerHTML = '<a href=\'' + altServerURL + '\'>' + altServerText + '<i class=\'material-icons\' style=\'font-size:10px;vertical-align:middle\'>arrow_forward_ios</i></a>';
        }
    
        function updateServerList() {
            window.vultr = {"scheme":"mm_prod","servers":[{"ip":"ed88d9cb934d760e4211b98df9be637c","scheme":"mm_prod","region":"vultr:9","index":5,"games":[{"playerCount":2,"isPrivate":false}]},{"ip":"9d3ff0f48a61a58f4eee53eba176fd40","scheme":"mm_prod","region":"vultr:12","index":2,"games":[{"playerCount":9,"isPrivate":false}]},{"ip":"f739e8638e774f59480f7b6ded275665","scheme":"mm_prod","region":"vultr:9","index":31,"games":[{"playerCount":39,"isPrivate":false}]},{"ip":"a3af1bf4735730113d8c54d27d0efc3e","scheme":"mm_prod","region":"vultr:12","index":4,"games":[{"playerCount":3,"isPrivate":false}]},{"ip":"a66ecbc2cf591b97bc4ddc12703d1c97","scheme":"mm_prod","region":"vultr:39","index":8,"games":[{"playerCount":1,"isPrivate":false}]},{"ip":"e1ce84acd1621e1dd32b19d715fe0fab","scheme":"mm_prod","region":"vultr:8","index":15,"games":[{"playerCount":2,"isPrivate":false}]},{"ip":"2d83949d03cc7bd34762e40c319f4a37","scheme":"mm_prod","region":"vultr:8","index":3,"games":[{"playerCount":0,"isPrivate":false}]},{"ip":"77c43cd2b115407f1f767a3d26768494","scheme":"mm_prod","region":"vultr:9","index":17,"games":[{"playerCount":0,"isPrivate":false}]},{"ip":"57634feefbe1741c42f7a187ba92b393","scheme":"mm_prod","region":"vultr:12","index":29,"games":[{"playerCount":0,"isPrivate":false}]},{"ip":"c4f6f85b246a0bbd8e6ba58ddceaf699","scheme":"mm_prod","region":"vultr:39","index":22,"games":[{"playerCount":0,"isPrivate":false}]},{"ip":"73488904285592b1c6c7c89589d809c0","scheme":"mm_prod","region":"vultr:9","index":18,"games":[{"playerCount":1,"isPrivate":false}]},{"ip":"e465d7b0aeac9ebbb5ce361775fb3c0c","scheme":"mm_prod","region":"vultr:19","index":1,"games":[{"playerCount":0,"isPrivate":false}]},{"ip":"b74304b33b9675605ad78c11d9546708","scheme":"mm_prod","region":"vultr:8","index":13,"games":[{"playerCount":1,"isPrivate":false}]},{"ip":"903c52ea08cc5a7484ce79ece176a6e0","scheme":"mm_prod","region":"vultr:8","index":10,"games":[{"playerCount":0,"isPrivate":false}]},{"ip":"97d5c4b4c790672650b81ea0ffcfacff","scheme":"mm_prod","region":"vultr:9","index":34,"games":[{"playerCount":2,"isPrivate":false}]},{"ip":"92eced72748451cd7acb5a97cb280982","scheme":"mm_prod","region":"vultr:19","index":8,"games":[{"playerCount":1,"isPrivate":false}]},{"ip":"2479ab52f8affd21ade3fb9faab682c0","scheme":"mm_prod","region":"vultr:39","index":17,"games":[{"playerCount":0,"isPrivate":false}]},{"ip":"c0c7153a9d7268201963f91678f1b302","scheme":"mm_prod","region":"vultr:8","index":16,"games":[{"playerCount":2,"isPrivate":false}]},{"ip":"3c2db6b9ea2a9761717fdee7d769c36b","scheme":"mm_prod","region":"vultr:12","index":13,"games":[{"playerCount":0,"isPrivate":false}]},{"ip":"c1bb3fdb77f824fc295067edc977bf31","scheme":"mm_prod","region":"vultr:39","index":40,"games":[{"playerCount":0,"isPrivate":false}]},{"ip":"f8c2bbb92d0bf98066aeadb88da67062","scheme":"mm_prod","region":"vultr:9","index":10,"games":[{"playerCount":2,"isPrivate":false}]},{"ip":"bbe4c5ed236b082819b85b9d05f7a624","scheme":"mm_prod","region":"vultr:19","index":3,"games":[{"playerCount":2,"isPrivate":false}]},{"ip":"bfd12ecba76d7f37b74683b03c5f6b6e","scheme":"mm_prod","region":"vultr:19","index":4,"games":[{"playerCount":1,"isPrivate":false}]},{"ip":"9a63e86262f1a7d0449213ca5164bb2f","scheme":"mm_prod","region":"vultr:39","index":41,"games":[{"playerCount":0,"isPrivate":false}]},{"ip":"d8830a4e3c1ecc1c48402c3a47de2056","scheme":"mm_prod","region":"vultr:9","index":36,"games":[{"playerCount":0,"isPrivate":false}]},{"ip":"c182138e7b4dca18ba17822be7b9b16c","scheme":"mm_prod","region":"vultr:12","index":3,"games":[{"playerCount":0,"isPrivate":false}]},{"ip":"37f396df98506d79074cd4630208cd6c","scheme":"mm_prod","region":"vultr:19","index":0,"games":[{"playerCount":0,"isPrivate":false}]},{"ip":"f08d40c7feed7f6b3c41661540e54aee","scheme":"mm_prod","region":"vultr:12","index":17,"games":[{"playerCount":0,"isPrivate":false}]},{"ip":"0ecee062f22c254499d9a88ad32e935f","scheme":"mm_prod","region":"vultr:39","index":34,"games":[{"playerCount":0,"isPrivate":false}]},{"ip":"e872860df32e9d1bed12087effa13d37","scheme":"mm_prod","region":"vultr:12","index":21,"games":[{"playerCount":0,"isPrivate":false}]},{"ip":"d504106cca76cbdd119f150e193ddc56","scheme":"mm_prod","region":"vultr:39","index":43,"games":[{"playerCount":0,"isPrivate":false}]},{"ip":"91f2217565273c46622df5792e474fd3","scheme":"mm_prod","region":"vultr:12","index":18,"games":[{"playerCount":0,"isPrivate":false}]},{"ip":"2b7062c0989d368213b7172b39b59592","scheme":"mm_prod","region":"vultr:40","index":10,"games":[{"playerCount":2,"isPrivate":false}]},{"ip":"69dfaa5efac6efe6f19df05a277b51c3","scheme":"mm_prod","region":"vultr:12","index":24,"games":[{"playerCount":0,"isPrivate":false}]},{"ip":"847a45eb6978c9154ef494c87731470e","scheme":"mm_prod","region":"vultr:19","index":13,"games":[{"playerCount":0,"isPrivate":false}]},{"ip":"474ebe305bfccbea9219c1c098b675f3","scheme":"mm_prod","region":"vultr:40","index":14,"games":[{"playerCount":5,"isPrivate":false}]},{"ip":"8ac41f0506a68e12b710dfa1609eb035","scheme":"mm_prod","region":"vultr:9","index":37,"games":[{"playerCount":0,"isPrivate":false}]},{"ip":"b90457413ed5a9afcf870dc51341d802","scheme":"mm_prod","region":"vultr:39","index":18,"games":[{"playerCount":0,"isPrivate":false}]},{"ip":"18ad9c00192e08035453e2dd1e90fa0c","scheme":"mm_prod","region":"vultr:12","index":19,"games":[{"playerCount":4,"isPrivate":false}]},{"ip":"36a604dfe6b0685673b2d16abab38062","scheme":"mm_prod","region":"vultr:8","index":8,"games":[{"playerCount":1,"isPrivate":false}]},{"ip":"15e536307fa013cbd183f256313761f0","scheme":"mm_prod","region":"vultr:19","index":6,"games":[{"playerCount":0,"isPrivate":false}]},{"ip":"1dd1a317fb6160425f552053cb7279f4","scheme":"mm_prod","region":"vultr:39","index":36,"games":[{"playerCount":0,"isPrivate":false}]},{"ip":"7f03f58f5ae4c8b3defb38a8dc75dc21","scheme":"mm_prod","region":"vultr:19","index":5,"games":[{"playerCount":1,"isPrivate":false}]},{"ip":"4289a912c44584b01d6525cfa2347455","scheme":"mm_prod","region":"vultr:12","index":7,"games":[{"playerCount":3,"isPrivate":false}]},{"ip":"e4fb1102ef459ccece8474b0cab99f5c","scheme":"mm_prod","region":"vultr:9","index":22,"games":[{"playerCount":1,"isPrivate":false}]},{"ip":"a8fcfdcac3ff68f440f0cc6f34ad1486","scheme":"mm_prod","region":"vultr:12","index":30,"games":[{"playerCount":0,"isPrivate":false}]},{"ip":"adf730a88d59537a45f69bd19215a759","scheme":"mm_prod","region":"vultr:40","index":19,"games":[{"playerCount":2,"isPrivate":false}]},{"ip":"b7550bed9b657363acdb25265e6e0b83","scheme":"mm_prod","region":"vultr:8","index":9,"games":[{"playerCount":7,"isPrivate":false}]},{"ip":"4daf0aa62de9a1aceb07dba80df1b0c7","scheme":"mm_prod","region":"vultr:39","index":46,"games":[{"playerCount":0,"isPrivate":false}]},{"ip":"d69d02bd8dbac3e5381bf56c3c2a0b25","scheme":"mm_prod","region":"vultr:9","index":15,"games":[{"playerCount":1,"isPrivate":false}]},{"ip":"b870bf9980deb5804b43b297f33f8301","scheme":"mm_prod","region":"vultr:39","index":12,"games":[{"playerCount":1,"isPrivate":false}]},{"ip":"09d949cba983a37f2a99123937e69404","scheme":"mm_prod","region":"vultr:9","index":35,"games":[{"playerCount":31,"isPrivate":false}]},{"ip":"1edbdce8019d4080f91216f0740d7d3c","scheme":"mm_prod","region":"vultr:8","index":2,"games":[{"playerCount":13,"isPrivate":false}]},{"ip":"5a0d9f744e6c35dced855e341edf9099","scheme":"mm_prod","region":"vultr:40","index":16,"games":[{"playerCount":1,"isPrivate":false}]},{"ip":"ee10a47b20c9c5cb7fcb56844cfa0005","scheme":"mm_prod","region":"vultr:9","index":6,"games":[{"playerCount":44,"isPrivate":false}]},{"ip":"fa59111c0c42e8a560157bc9ec97383d","scheme":"mm_prod","region":"vultr:8","index":14,"games":[{"playerCount":1,"isPrivate":false}]},{"ip":"6984877c29e9e29d7bf954866cdc1f17","scheme":"mm_prod","region":"vultr:39","index":48,"games":[{"playerCount":0,"isPrivate":false}]},{"ip":"bbe68afcab9ee9818ba045d0e8e58fc8","scheme":"mm_prod","region":"vultr:9","index":30,"games":[{"playerCount":1,"isPrivate":false}]},{"ip":"cb9f093d8f14a296f44e1fbd86b6ef76","scheme":"mm_prod","region":"vultr:39","index":38,"games":[{"playerCount":0,"isPrivate":false}]},{"ip":"d60d48b7de4080fd171f3fa89feb7bff","scheme":"mm_prod","region":"vultr:40","index":1,"games":[{"playerCount":25,"isPrivate":false}]},{"ip":"cf125230a039e412f6b7955b67ec0bb0","scheme":"mm_prod","region":"vultr:39","index":42,"games":[{"playerCount":1,"isPrivate":false}]},{"ip":"5a955d53ea646b85730bad866316703b","scheme":"mm_prod","region":"vultr:12","index":20,"games":[{"playerCount":0,"isPrivate":false}]},{"ip":"dbc72d8057eddb1a499b842d7a2323f1","scheme":"mm_prod","region":"vultr:8","index":11,"games":[{"playerCount":0,"isPrivate":false}]},{"ip":"9e6e7f66bf327048047158db6039dd95","scheme":"mm_prod","region":"vultr:39","index":24,"games":[{"playerCount":0,"isPrivate":false}]},{"ip":"048e83a4b1d478a9e46340cd4e6849df","scheme":"mm_prod","region":"vultr:39","index":47,"games":[{"playerCount":0,"isPrivate":false}]},{"ip":"d85c7232ece3081e1ab0e7be27c1993d","scheme":"mm_prod","region":"vultr:40","index":18,"games":[{"playerCount":15,"isPrivate":false}]},{"ip":"cb9d50ea960d462929999b59327afe4e","scheme":"mm_prod","region":"vultr:9","index":14,"games":[{"playerCount":1,"isPrivate":false}]},{"ip":"dd6a8e531eca380803f6b3ddaed21315","scheme":"mm_prod","region":"vultr:19","index":11,"games":[{"playerCount":2,"isPrivate":false}]},{"ip":"348e2dd40b5b686e729dbc03b4782a32","scheme":"mm_prod","region":"vultr:19","index":9,"games":[{"playerCount":0,"isPrivate":false}]},{"ip":"001d45ddce58ef631910eeba7f4bedaa","scheme":"mm_prod","region":"vultr:39","index":23,"games":[{"playerCount":0,"isPrivate":false}]},{"ip":"8e46218a8595e9e8b9399fe1b1a76d81","scheme":"mm_prod","region":"vultr:9","index":29,"games":[{"playerCount":1,"isPrivate":false}]},{"ip":"4b53e3d4535eea59e836592905d80a6a","scheme":"mm_prod","region":"vultr:9","index":20,"games":[{"playerCount":0,"isPrivate":false}]},{"ip":"d206497a0ab6977364491fc66d2e305a","scheme":"mm_prod","region":"vultr:12","index":31,"games":[{"playerCount":0,"isPrivate":false}]},{"ip":"6f3e285f5906f36cce924295ab6197d5","scheme":"mm_prod","region":"vultr:19","index":2,"games":[{"playerCount":0,"isPrivate":false}]},{"ip":"4c2bf45acfc9749e05c1c042f9d13c6a","scheme":"mm_prod","region":"vultr:9","index":33,"games":[{"playerCount":10,"isPrivate":false}]},{"ip":"e053652bb825d6b57e9e9a1661b3b8b9","scheme":"mm_prod","region":"vultr:8","index":7,"games":[{"playerCount":1,"isPrivate":false}]},{"ip":"d715dac0a94682b88a7d3a6b3c802f97","scheme":"mm_prod","region":"vultr:12","index":10,"games":[{"playerCount":0,"isPrivate":false}]},{"ip":"32b98733825d999bb33d5c099b0c0764","scheme":"mm_prod","region":"vultr:39","index":25,"games":[{"playerCount":0,"isPrivate":false}]},{"ip":"1e3b4d1e96b7fce5dfb02e1bfd3c9123","scheme":"mm_prod","region":"vultr:40","index":12,"games":[{"playerCount":1,"isPrivate":false}]},{"ip":"f4ae808d1a9a8fe4ae48b2e1b489f7a3","scheme":"mm_prod","region":"vultr:39","index":7,"games":[{"playerCount":6,"isPrivate":false}]},{"ip":"36e9fa8324a9e8e49b0dfd0da276b514","scheme":"mm_prod","region":"vultr:8","index":12,"games":[{"playerCount":2,"isPrivate":false}]},{"ip":"56ebc5f08f75357157156d152372263e","scheme":"mm_prod","region":"vultr:9","index":8,"games":[{"playerCount":12,"isPrivate":false}]},{"ip":"4120add80710fb44bd9580f5d6d0ae10","scheme":"mm_prod","region":"vultr:9","index":2,"games":[{"playerCount":42,"isPrivate":false}]},{"ip":"62432815b696fa5a1bb2e47503f5eefb","scheme":"mm_prod","region":"vultr:9","index":7,"games":[{"playerCount":23,"isPrivate":false}]},{"ip":"16b6f21156aa4167c8c7037efcfacbeb","scheme":"mm_prod","region":"vultr:39","index":9,"games":[{"playerCount":0,"isPrivate":false}]},{"ip":"9fb301aa234b65a980939378770f38fa","scheme":"mm_prod","region":"vultr:12","index":12,"games":[{"playerCount":0,"isPrivate":false}]},{"ip":"77eb61e996c592482a4f245dd334609b","scheme":"mm_prod","region":"vultr:12","index":23,"games":[{"playerCount":0,"isPrivate":false}]},{"ip":"bdaac5f42524a76a5468eb557c4424cc","scheme":"mm_prod","region":"vultr:9","index":38,"games":[{"playerCount":0,"isPrivate":false}]},{"ip":"627494c75cffac5beba587c4602f1700","scheme":"mm_prod","region":"vultr:39","index":44,"games":[{"playerCount":0,"isPrivate":false}]},{"ip":"22b9ab05903afbffeeeaab034b80dbda","scheme":"mm_prod","region":"vultr:39","index":45,"games":[{"playerCount":0,"isPrivate":false}]},{"ip":"e310383db1798bb46cc09702c08eac11","scheme":"mm_prod","region":"vultr:40","index":6,"games":[{"playerCount":13,"isPrivate":false}]},{"ip":"1be99d91d367e7c6d6613c6f040b4bb0","scheme":"mm_prod","region":"vultr:12","index":27,"games":[{"playerCount":1,"isPrivate":false}]},{"ip":"1b917df02ab4180b16525dcbe4f9cbce","scheme":"mm_prod","region":"vultr:39","index":16,"games":[{"playerCount":0,"isPrivate":false}]},{"ip":"84b30ef7a3bca1fc23d018da49a1969f","scheme":"mm_prod","region":"vultr:40","index":8,"games":[{"playerCount":3,"isPrivate":false}]},{"ip":"c15a3a615ceccb3c1bb1381fc7574b63","scheme":"mm_prod","region":"vultr:39","index":4,"games":[{"playerCount":37,"isPrivate":false}]},{"ip":"7797afc9040b5b02bb2d61ea4af2f1d3","scheme":"mm_prod","region":"vultr:39","index":31,"games":[{"playerCount":1,"isPrivate":false}]},{"ip":"fe47c420740717afef453de4360587b0","scheme":"mm_prod","region":"vultr:9","index":0,"games":[{"playerCount":42,"isPrivate":false}]},{"ip":"8f5f714974db936f97f626a97801cc64","scheme":"mm_prod","region":"vultr:39","index":11,"games":[{"playerCount":0,"isPrivate":false}]},{"ip":"0d6f90fa847c9fd074ee98e05eb54d21","scheme":"mm_prod","region":"vultr:19","index":10,"games":[{"playerCount":0,"isPrivate":false}]},{"ip":"7153cc0d9b7694a4bf9b50d586009cb0","scheme":"mm_prod","region":"vultr:40","index":2,"games":[{"playerCount":34,"isPrivate":false}]},{"ip":"891a5f5d6cce6914c388a25a6e3684e2","scheme":"mm_prod","region":"vultr:9","index":23,"games":[{"playerCount":1,"isPrivate":false}]},{"ip":"adbbac2d53e3701a4a48539b2f2421a6","scheme":"mm_prod","region":"vultr:9","index":1,"games":[{"playerCount":43,"isPrivate":false}]},{"ip":"f971075005cadfc6c785f89473e6d927","scheme":"mm_prod","region":"vultr:39","index":33,"games":[{"playerCount":15,"isPrivate":false}]},{"ip":"12135eda7bfa0160991075d1b194339a","scheme":"mm_prod","region":"vultr:9","index":19,"games":[{"playerCount":0,"isPrivate":false}]},{"ip":"18de634aedc7f0d18a3b8fcf1e7ee855","scheme":"mm_prod","region":"vultr:12","index":9,"games":[{"playerCount":0,"isPrivate":false}]},{"ip":"f7dacae0e61501e1a3c4fcad4234cdd8","scheme":"mm_prod","region":"vultr:39","index":35,"games":[{"playerCount":0,"isPrivate":false}]},{"ip":"a82d6d48ebf17687a640c54718bed14b","scheme":"mm_prod","region":"vultr:12","index":14,"games":[{"playerCount":0,"isPrivate":false}]},{"ip":"c9f88f4c9a6cecf11d9f8db73e4713fb","scheme":"mm_prod","region":"vultr:39","index":6,"games":[{"playerCount":0,"isPrivate":false}]},{"ip":"19cd9eba78f8d7b97aaf27e6b56d81ad","scheme":"mm_prod","region":"vultr:9","index":25,"games":[{"playerCount":0,"isPrivate":false}]},{"ip":"e7adb341b070146bf963c499e00112d7","scheme":"mm_prod","region":"vultr:12","index":1,"games":[{"playerCount":1,"isPrivate":false}]},{"ip":"b33eaf0cdb5ab5d69c40ef10d3f52115","scheme":"mm_prod","region":"vultr:19","index":7,"games":[{"playerCount":4,"isPrivate":false}]},{"ip":"702203e23edcb3ff4aafd2be76e1c895","scheme":"mm_prod","region":"vultr:40","index":9,"games":[{"playerCount":2,"isPrivate":false}]},{"ip":"04b229e88e76015c37b736fcd7c19e81","scheme":"mm_prod","region":"vultr:9","index":21,"games":[{"playerCount":3,"isPrivate":false}]},{"ip":"e034fadd487e13b16695a77efe6265f9","scheme":"mm_prod","region":"vultr:39","index":28,"games":[{"playerCount":10,"isPrivate":false}]},{"ip":"d0b39045887ba2502ff22e8746cd3a65","scheme":"mm_prod","region":"vultr:9","index":26,"games":[{"playerCount":2,"isPrivate":false}]},{"ip":"e6ced1a77cd4bd89e1f565e45cc9267a","scheme":"mm_prod","region":"vultr:12","index":15,"games":[{"playerCount":1,"isPrivate":false}]},{"ip":"6c7817cc2201296d94bf78f64b471bfa","scheme":"mm_prod","region":"vultr:39","index":27,"games":[{"playerCount":0,"isPrivate":false}]},{"ip":"34b4e7105cf6d28d690f21b599e2bd3b","scheme":"mm_prod","region":"vultr:39","index":10,"games":[{"playerCount":18,"isPrivate":false}]},{"ip":"7f58385a22bcef4673ddf7b865170641","scheme":"mm_prod","region":"vultr:40","index":13,"games":[{"playerCount":1,"isPrivate":false}]},{"ip":"c018e16a680561cc756c99ce522fb30c","scheme":"mm_prod","region":"vultr:9","index":24,"games":[{"playerCount":1,"isPrivate":false}]},{"ip":"3b2452b4a09f7bc29c1a70a8cb732292","scheme":"mm_prod","region":"vultr:12","index":33,"games":[{"playerCount":0,"isPrivate":false}]},{"ip":"4b6c25adc6a13cb625468f3590cb3b3a","scheme":"mm_prod","region":"vultr:8","index":0,"games":[{"playerCount":43,"isPrivate":false}]},{"ip":"493cca07f5a0d2bb378fc3e6ead8a423","scheme":"mm_prod","region":"vultr:8","index":18,"games":[{"playerCount":0,"isPrivate":false}]},{"ip":"601e74ea6a3631fbe91e4cfff390b319","scheme":"mm_prod","region":"vultr:8","index":17,"games":[{"playerCount":20,"isPrivate":false}]},{"ip":"3de7bf36bc98806e05945207ae4cca32","scheme":"mm_prod","region":"vultr:8","index":6,"games":[{"playerCount":27,"isPrivate":false}]},{"ip":"2ebaa79f791031a2c1e97b24e41d874f","scheme":"mm_prod","region":"vultr:19","index":14,"games":[{"playerCount":1,"isPrivate":false}]},{"ip":"aa6f8941d18d90b2d82cbb9d088013c0","scheme":"mm_prod","region":"vultr:9","index":32,"games":[{"playerCount":3,"isPrivate":false}]},{"ip":"602651906a7fe2cd110708a942b0f408","scheme":"mm_prod","region":"vultr:12","index":8,"games":[{"playerCount":0,"isPrivate":false}]},{"ip":"73ae26c463e62efde60ee71e5018b998","scheme":"mm_prod","region":"vultr:39","index":19,"games":[{"playerCount":0,"isPrivate":false}]},{"ip":"c3877233bec735e786fd25fdabc009d0","scheme":"mm_prod","region":"vultr:40","index":0,"games":[{"playerCount":37,"isPrivate":false}]},{"ip":"82f2c37cc6661cbb00443550c35a4c0e","scheme":"mm_prod","region":"vultr:9","index":16,"games":[{"playerCount":3,"isPrivate":false}]},{"ip":"f82507e35a9dfdfaffb999240ce29f26","scheme":"mm_prod","region":"vultr:9","index":28,"games":[{"playerCount":5,"isPrivate":false}]},{"ip":"26a314d019d81ce272ea54f77ec69a27","scheme":"mm_prod","region":"vultr:9","index":39,"games":[{"playerCount":0,"isPrivate":false}]},{"ip":"49040da7e6244f1b77494a1892b33f86","scheme":"mm_prod","region":"vultr:40","index":17,"games":[{"playerCount":4,"isPrivate":false}]},{"ip":"3c2204fd9e14719c9a0a1e321bad4bdb","scheme":"mm_prod","region":"vultr:40","index":3,"games":[{"playerCount":2,"isPrivate":false}]},{"ip":"d5966941aa72831ad0991573d5f620b8","scheme":"mm_prod","region":"vultr:40","index":7,"games":[{"playerCount":2,"isPrivate":false}]},{"ip":"97291bd2e008ee92a71ae9504727e51e","scheme":"mm_prod","region":"vultr:39","index":3,"games":[{"playerCount":41,"isPrivate":false}]},{"ip":"2c1996d9cdaf5f1f915912acf00fd5f9","scheme":"mm_prod","region":"vultr:39","index":13,"games":[{"playerCount":1,"isPrivate":false}]},{"ip":"ba06dbfecbcf7f38afbc743283305134","scheme":"mm_prod","region":"vultr:40","index":4,"games":[{"playerCount":0,"isPrivate":false}]},{"ip":"4dc263c85fa06b63d0be984422b7210f","scheme":"mm_prod","region":"vultr:19","index":12,"games":[{"playerCount":0,"isPrivate":false}]},{"ip":"c96795b9d23b23584d41250c7bfd31cb","scheme":"mm_prod","region":"vultr:8","index":5,"games":[{"playerCount":9,"isPrivate":false}]},{"ip":"65cd75410d4ee0e1d1af89b5cfea2b0e","scheme":"mm_prod","region":"vultr:39","index":14,"games":[{"playerCount":0,"isPrivate":false}]},{"ip":"3607bded4852929755b6d33dc03dd56f","scheme":"mm_prod","region":"vultr:40","index":15,"games":[{"playerCount":1,"isPrivate":false}]},{"ip":"77cdccd1ecfbcaa34a3262626e8114d5","scheme":"mm_prod","region":"vultr:39","index":15,"games":[{"playerCount":0,"isPrivate":false}]},{"ip":"67150cf6e980dc3e65d785f9e27a7692","scheme":"mm_prod","region":"vultr:39","index":32,"games":[{"playerCount":0,"isPrivate":false}]},{"ip":"f1822f57474051694a5baa91f1104fdb","scheme":"mm_prod","region":"vultr:39","index":2,"games":[{"playerCount":5,"isPrivate":false}]},{"ip":"7814b15ea171d4b0eddd59d4d06feb65","scheme":"mm_prod","region":"vultr:39","index":26,"games":[{"playerCount":0,"isPrivate":false}]},{"ip":"aa45b4e6ca10eead8438c3086ec5ea90","scheme":"mm_prod","region":"vultr:12","index":11,"games":[{"playerCount":0,"isPrivate":false}]},{"ip":"cf65d841667b64ad09c3c93b8d570686","scheme":"mm_prod","region":"vultr:12","index":16,"games":[{"playerCount":0,"isPrivate":false}]},{"ip":"df25e767d72f913bf47adcca5eb7606a","scheme":"mm_prod","region":"vultr:12","index":34,"games":[{"playerCount":0,"isPrivate":false}]},{"ip":"752a05825ccab935bb1a69abcc03b7f4","scheme":"mm_prod","region":"vultr:9","index":12,"games":[{"playerCount":3,"isPrivate":false}]},{"ip":"038977999fea4ed8cbb93f5e54163612","scheme":"mm_prod","region":"vultr:39","index":20,"games":[{"playerCount":0,"isPrivate":false}]},{"ip":"8d07788ab72468983d95c2be06837e9d","scheme":"mm_prod","region":"vultr:12","index":32,"games":[{"playerCount":0,"isPrivate":false}]},{"ip":"a04787efc5fa7a00952e164c1ebf22ba","scheme":"mm_prod","region":"vultr:39","index":39,"games":[{"playerCount":0,"isPrivate":false}]},{"ip":"2ee2eba39ad0700366ccb1dfe79d0643","scheme":"mm_prod","region":"vultr:9","index":9,"games":[{"playerCount":39,"isPrivate":false}]},{"ip":"4c933474321d24c292dc3e28385251fd","scheme":"mm_prod","region":"vultr:8","index":19,"games":[{"playerCount":1,"isPrivate":false}]},{"ip":"6b8a280031b0411c48f6ac94264f2c42","scheme":"mm_prod","region":"vultr:39","index":30,"games":[{"playerCount":0,"isPrivate":false}]},{"ip":"3938ffc16079face1417f5590f1df725","scheme":"mm_prod","region":"vultr:40","index":5,"games":[{"playerCount":1,"isPrivate":false}]},{"ip":"5b860fc54de2580b2528d6adc53f325d","scheme":"mm_prod","region":"vultr:9","index":11,"games":[{"playerCount":2,"isPrivate":false}]}]};
            ...
            /*xmlhttp.onreadystatechange = function () {
                4 == this.readyState && (200 == this.status ? (window.vultr = JSON.parse(this.responseText), vultrClient.processServers(window.vultr.servers), setupServerStatus()) : console.error('Failed to load server data with status code:', this.status));
            }, xmlhttp.open('GET', '/serverData.json', !0), xmlhttp.send();*/
        }
                ...
                for (var index = currentStoreIndex, tmpArray = index ? accessories : hats, i = 0; i < tmpArray.length; ++i)
                    tmpArray[i].dontSell || function (i) {
                        ...
                        UTILS.hookTouchEvents(tmp, !0), UTILS.generateElement({
                            tag: 'img',
                            class: 'hatPreview',
                            src: 'https://moomoo.io/img/' + (index ? 'accessories/access_' : 'hats/hat_') + tmpArray[i].id + (tmpArray[i].topSprite ? '_p' : '') + '.png',
                            parent: tmp
                        }), UTILS.generateElement({
                            tag: 'span',
        ...
        function renderProjectile(x, y, obj, ctxt, debug) {
            if (obj.src) {
                ...
                tmpSprite || ((tmpSprite = new Image()).onload = function () {
                    this.isLoaded = !0;
                }, tmpSprite.src = 'https://moomoo.io/img/weapons/' + tmpSrc + '.png', projectileSprites[tmpSrc] = tmpSprite), tmpSprite.isLoaded && ctxt.drawImage(tmpSprite, x - obj.scale / 2, y - obj.scale / 2, obj.scale, obj.scale);
            } else
        ...
        function renderPlayer(e, t) {
            ...
            if (e.tailIndex > 0 && function (index, ctxt, owner) {
                    if (!(tmpSkin = accessSprites[index])) {
                        ...
                        }, tmpImage.src = 'https://moomoo.io/img/accessories/access_' + index + '.png', accessSprites[index] = tmpImage, tmpSkin = tmpImage;
                    }
            ...
            renderCircle(0, 0, e.scale, t), e.skinIndex > 0 && (t.rotate(Math.PI / 2), function renderSkin(index, ctxt, parentSkin, owner) {
                if (!(tmpSkin = skinSprites[index])) {
                    ...
                    tmpImage.onload = function () {
                        this.isLoaded = !0, this.onload = null;
                    }, tmpImage.src = 'https://moomoo.io/img/hats/hat_' + index + '.png', skinSprites[index] = tmpImage, tmpSkin = tmpImage;
                }
        ...
        function renderTool(obj, variant, x, y, ctxt) {
            ...
            tmpSprite || ((tmpSprite = new Image()).onload = function () {
                this.isLoaded = !0;
            }, tmpSprite.src = 'https://moomoo.io/img/weapons/' + tmpSrc + '.png', toolSprites[tmpSrc] = tmpSprite), tmpSprite.isLoaded && ctxt.drawImage(tmpSprite, x + obj.xOff - obj.length / 2, y + obj.yOff - obj.width / 2, obj.length, obj.width);
        }
            ...
            connect: function (address, callback, events) {
                ...
                if (!this.socket) {
                    ...
                    try {
                        ...
                        this.socket = new WebSocket(socketAddress), this.socket.binaryType = 'arraybuffer';
                      this.socket.onmessage = function (message) {
                          var data = new Uint8Array(message.data), parsed = decoder.decode(data), type = parsed[0];
                            ...
                            console.log("fff");
                            _this.connected = !1, 4001 == event.code ? callback('Invalid connection') : socketError || callback('Flower is updating the code');
    ...
    function (module, t, __webpack_require__) {
      ...
      // I have a better bundle if you need. More clear
    ...
    function (module, t) {
        ...
        module.exports.obj = function (config, UTILS) {
            ...
            this.sounds = [], this.active = !0, this.play = function (id, volume, loop) {
                ...
                (tmpSound = this.sounds[id]) && tmpSound.mute(mute); //mute lwakm
    ...
    function (module, t, __webpack_require__) {
        ...
        function VultrClient(baseUrl, devPort, lobbySize, lobbySpread, rawIPs) {
            'localhost' == location.hostname && (window.location.hostname = '127.0.0.1'), this.debugLog = !1, this.baseUrl = baseUrl, this.lobbySize = lobbySize, this.devPort = devPort, this.lobbySpread = lobbySpread, this.rawIPs = !!rawIPs, this.server = void 0, this.gameIndex = void 0, this.callback = void 0, this.errorCallback = void 0, this.processServers(window.vultr.servers);
        }
        VultrClient.prototype.regionInfo = {
            ...
            for (var region in this.servers)
                if (this.servers.hasOwnProperty(region)) {
                    ...
                    null != targetServer ? function (serverList, targetServer) {
                        ...
                        console.log(_this.serverAddress(targetServer.ip, !0));
                        console.log(_this.serverPort(targetServer));
                        var targetAddress = '//' + _this.serverAddressSEX(targetServer.ip, !0) + ':' + _this.serverPort(targetServer) + '/ping';
        ...
        }, VultrClient.prototype.serverAddressSEX = function (ip, forceSecure) {
            return '127.0.0.1' == ip || '7f000001' == ip || '903d62ef5d1c2fecdcaeb5e7dd485eff' == ip ? window.location.hostname : this.rawIPs ? forceSecure ? 'ip_' + this.hashIP(ip) + '.' + 'moomoo.io' : ip : 'ip_' + ip + '.' + 'moomoo.io';
            ...
            var client1 = new VultrClient('test.me', -1, 5, 1, !1); // nigger
